...
def run_muscle_force_groups_summary(bool, save_figures):
    if bool:
        try:
            ...
            figure_2_postfix = "spm_check_athlete_0"
            ...
            fig_2.set_size_inches(13, 7.5)
            if save_figures:
                plt.savefig(
                    "../results/muscle_forces/" + figure_2_postfix + ".png",
                    transparent=None,
                    dpi=300,
                    format="png",
                )
